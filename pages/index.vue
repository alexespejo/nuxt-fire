...
const welcomeMessage = ref("Welcome to the Social Network");
</script>
<template>
 <NuxtLayout name="default">
  ...
  <div
   class="absolute bg-slate-100/40 w-screen h-screen flex flex-col justify-center items-center"
  >
   <div
    class="flex justify-center items-center flex-col bg-white/80 space-y-5 p-4 md:border-2 rounded-xl shadow-sm"
   >
    ...
    <button @click="signInWithGoogle" class="btn-bordered bg-white text-2xl">
     Get Started!
    </button>
    <div>
     {{ screenSize.width }}
